...
return [
    ...
    'providers' => [
        ...
        'gemini_native' => [
            'label' => 'gemini',
            'api_key' => env('GEMINI_API_KEY'),
            // Driver con fix de function_response en historial persistido:
            'driver' => \App\AiAgents\LlmDrivers\NativeGeminiDriver::class,
            // 'driver' => \LarAgent\Drivers\Gemini\GeminiDriver::class,
            'default_truncation_threshold' => 1000000,
            'default_max_completion_tokens' => 10000,
            'default_temperature' => 1,
            'model' => 'gemini-2.5-pro', // Soporte para visión/imágenes
        ],
